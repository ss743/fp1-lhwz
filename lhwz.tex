...
In the following sections we will analyze the data we recorded in our measurements to determine the working point and to determine the half-lives of the samples.
...
In figure \ref{curan} we see two plateaus. The first plateau comes from the $\alpha$-decay of $^{238}$U and the second plateau shows the $\beta$-decay of $^{234}$Th and $^{234}$Pd (see section \ref{uranium}). The plateaus are between $U=1900\,\mathrm{V}$ and $U=2600\,\mathrm{V}$ for $\alpha$ and between $U=3200\,\mathrm{V}$ and $U=4000\,\mathrm{V}$ for $\beta$.
The error on the counting rate is here and in the following chapters given by the Poisson error on the counts: 
\begin{align}
...
We measured the background radiation by putting an empty aluminium dish inside the counter tube (see chapter \ref{durchfuehrunguran}).
...
Now we tried to get the working point for the Samarium measurements (see chapter \ref{durchfuehrungsamarium}). Therefore we measured the counter tube characteristics of Samarium in a span starting at the beginning of the $\alpha$-plateau of uranium and ending on the beginning of the $\beta$-plateau of uranium.
