...
${}^{40}$Kalium can decay via two decays: Either via $\beta^-$-Zerfall (see section \ref{beta}) to ${}^{40}$Calcium or via electron capture to ${}^{40}$Argon:
...
\newpage
\subsection{Half-life of Samarium \label{HS}}
