...
${}^{40}$Kalium can decay via two decays: Either via $\beta^-$-decay to ${}^{40}$Calcium or via electron capture (see section \ref{ec}) to ${}^{40}$Argon:
...
\newpage
\subsection{Half-life of Samarium}\label{auswertungSamarium}
